 ...
 *
 * IMPORTANT: This module provides routing INFORMATION only.
 * It does NOT submit to Baltimore 311 API, Open311, or any city portal.
 * Baltimore 311 API does not work. This is for human-confirmed handoff only.
 *
 ...
 * 
 * Returns routing INFORMATION only - which agency handles this type of issue,
 * their contact info, and urgency level. Does NOT submit anything.
 ...
 * @returns {object} Routing recommendation (info only, not submission)
 */
