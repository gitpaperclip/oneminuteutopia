...
export const GEMINI_SCHEMA = {
  ...
  properties: {
    ...
    context_tags: { type: 'array', items: { type: 'string' }, maxItems: 8 },
  },
...
Seriousness is the image-based danger level from 0-10, not a category default and
not an overall incident score. Judge the visible scene: a small pothole is about 3,
a large or deep pothole 4-5, minor scattered trash about 2, trash blocking a sidewalk
3-4, a traffic signal malfunction about 6, a major roadway obstruction 7-8, and a
fallen live power line or similar immediate infrastructure danger 9-10.
...
Allowed context tags: ${CONTEXT_TAGS.join(', ')}.
context_tags contains up to 8 applicable allowed tags and no speculation.
