...
export type SeverityTone = 'blue' | 'teal' | 'amber' | 'red' | 'gray';
...
const STYLES: Record<SeverityTone, Omit<SeverityStyle, 'tone'>> = {
  blue: { accent: '#2563eb', fill: '#dbeafe', label: 'Low risk' },
  teal: { accent: '#0d9488', fill: '#ccfbf1', label: 'Medium risk' },
  amber: { accent: '#d97706', fill: '#fef3c7', label: 'High risk' },
  red: { accent: '#dc2626', fill: '#fee2e2', label: 'Critical risk' },
